...
//    }
    ...
    public void create(Folder folder) {
        ...
        // Matrix folder
        final Long matrixId = folder.getId(Folder.EPath.MATRIX);
        final String matrixFolder = this.convertMatrixIdToFolder(matrixId);
        
        // Category folder
        final Long categoryId = folder.getId(Folder.EPath.CATEGORY);
        final String categoryFolder = this.convertCategoryIdToFolder(matrixId, categoryId);
        
        // SubCategory folder
//        final Long subCategoryId = folder.getId(Folder.EPath.SUBCATEGORY);
        final String subCategoryFolder = null;//this.convertSubCategoryIdToFolder(matrixId, categoryId, subCategoryId);
        
        // Create folders
        final Long levelId = folder.getId(Folder.EPath.LEVEL);
        if (levelId == null) {
        	// Create the folder
            final String pathWithFolder = this.createPathWithFolder(matrixFolder, categoryFolder, subCategoryFolder);
...
//        String pathWithFolder = this.createPathWithFolder(matrixFolder, categoryFolder, subCategoryFolder, levelFolder);
//        File file = new File(pathWithFolder);
//        file.mkdirs();
//        
//        levelFolder = this.convertLevelIdToFolder(IFolderHelper.LEVEL_2);
//        pathWithFolder = this.createPathWithFolder(matrixFolder, categoryFolder, subCategoryFolder, levelFolder);
...
//        file.mkdirs();
    ...
    private String createPathWithFolder(String matrixFolder, String categoryFolder, String subCategoryFolder) {
    ...
    private String createPathWithFolder(String matrixFolder, String categoryFolder, String subCategoryFolder, String levelFolder) {
        final StringBuilder pathWithFolder = new StringBuilder();
        pathWithFolder.append(this.createPathWithFolder(matrixFolder, categoryFolder, subCategoryFolder));
...
//        final Long subCategoryId = folder.getId(Folder.EPath.SUBCATEGORY);
        ...
        // Level folder
        final Long levelId = folder.getId(Folder.EPath.LEVEL);
        String levelFolder = null;// this.convertLevelIdToFolder(levelId);
        
        // Open the folder
        final Desktop desktop = Desktop.getDesktop();
        final String pathWithFolder = this.createPathWithFolder(matrixFolder, categoryFolder, subCategoryFolder, levelFolder);
